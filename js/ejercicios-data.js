const EJERCICIOS_DB = { arepazo: 'arepazo', nba: 'nba', futbol: 'futbol', refugio: 'refugio', heroes: 'heroes', hogwarts: 'hogwarts', arkham: 'arkham', dnd: 'dnd', mmorpg: 'mmorpg', dungeon: 'dungeon', baloncesto: 'baloncesto', cosmere: 'cosmere' };
const BLOQUES = [
  // --- TEORÍA (Módulo 0372) ---
  ...
  { id: 103, tipo: "teoria", nombre: "Tema 3: Modelo físico (DDL)", modulo: "0372", curso: "1º ASIR", ra: "3", implementado: true, desc: "Creación de tablas, restricciones, tipos de datos." },
  ...
  { id: 2, tipo: "ejercicios", temaRef: 104, nombre: "Ejercicios: Consultas Básicas", modulo: "0372", curso: "1º ASIR", ra: "4", implementado: true, desc: "SELECT simples, WHERE, ORDER BY, LIMIT." },
  { id: 3, tipo: "ejercicios", temaRef: 104, nombre: "Ejercicios: Consultas Avanzadas", modulo: "0372", curso: "1º ASIR", ra: "4", implementado: true, desc: "Funciones de agregado, GROUP BY, HAVING, JOINs." },
  { id: 4, tipo: "ejercicios", temaRef: 104, nombre: "Ejercicios: Consultas Difíciles", modulo: "0372", curso: "1º ASIR", ra: "4", implementado: true, desc: "Subconsultas y consultas complejas." },
  
  // --- TEORÍA (Módulo 0377 - 2º ASIR - Administración SGBD) ---
  { id: 201, tipo: "teoria", nombre: "Tema 1: Instalación de SGBD", modulo: "0377", curso: "2º ASIR", ra: "1", implementado: true, desc: "Tipos de SGBD, Docker, VirtualBox, MariaDB, Oracle, SQL Server." },
  { id: 202, tipo: "teoria", nombre: "Tema 2: Configuración y Arquitectura", modulo: "0377", curso: "2º ASIR", ra: "2", implementado: true, desc: "Parámetros, motores (InnoDB), conexiones y logs en MariaDB." },
  { id: 203, tipo: "teoria", nombre: "Tema 3: Seguridad y Control de Acceso", modulo: "0377", curso: "2º ASIR", ra: "3", implementado: true, desc: "Usuarios, roles, privilegios (GRANT/REVOKE), vistas y sinónimos." },
